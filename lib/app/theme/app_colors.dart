...
class AppColors {
  ...
  //PRIMARY
  static Color primary = const Color(0xff37A0F4);
  static Color primaryLighter = const Color(0xff37A0F4).withOpacity(0.1);
  static Color primaryLight = const Color(0xff37A0F4).withOpacity(0.3);
  static Color primaryDark = const Color(0xff37A0F4);

  //PRIMARY
  static Color secondary = const Color(0xffD3AF37);
  static Color secondaryDark = const Color(0xffD3AF37);
  static Color secondaryLight = const Color(0xffD3AF37).withOpacity(0.3);
  static Color secondaryLighter = const Color(0xffD3AF37).withOpacity(0.1);
